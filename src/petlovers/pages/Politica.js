        ...
        <KeyboardAwareScrollView style={{ flex: 1 }}>  
            <View style={styles.container}>
                ...
                <Text style={styles.text}>
                    Coletamos informações pessoais limitadas de nossos usuários para fornecer e melhorar nossos serviços. 
                ...
                <Text style={styles.text}>
                    Implementamos medidas de segurança adequadas para proteger suas informações pessoais contra acesso não autorizado, uso indevido ou alteração. 
                ...
                <Text style={styles.text}>
                    Nosso aplicativo não é destinado a menores de 18 anos e não coletamos 
...
const styles = StyleSheet.create({
    ...
    arrow: {
        // Estilos para o componente de seta
    },
    title:{
        color: '#5F5B5B',
        fontSize: 25,
